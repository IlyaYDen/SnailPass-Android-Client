...
public final class PasswordListAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.example.snailpasswordmanager.presentation.mainscreen.PasswordListAdapter.PasswordItemViewHolder> {
    ...
    private java.util.ArrayList<com.example.snailpasswordmanager.domain.model.RecordEntity> list;
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.ArrayList<com.example.snailpasswordmanager.domain.model.RecordEntity> getList() {
        return null;
    }
    
    public final void setList(@org.jetbrains.annotations.NotNull()
    java.util.ArrayList<com.example.snailpasswordmanager.domain.model.RecordEntity> value) {
    }
    
    public final void setPasswords(@org.jetbrains.annotations.NotNull()
    java.util.List<com.example.snailpasswordmanager.domain.model.RecordEntity> li) {
    }
