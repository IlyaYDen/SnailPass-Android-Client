...
public final class DataModule {
    ...
    @dagger.Provides()
    public final com.example.snailpasswordmanager.data.database.record.RecordDb providePasswordDb(@org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    @dagger.Provides()
    public final com.example.snailpasswordmanager.domain.repository.RecordListRepository providePasswordListRepository(@org.jetbrains.annotations.NotNull()
    com.example.snailpasswordmanager.data.database.record.RecordDb db) {
        return null;
    }
    ...
    @dagger.Provides()
    public final com.example.snailpasswordmanager.data.database.record.RecordDao providePasswordDao(@org.jetbrains.annotations.NotNull()
    com.example.snailpasswordmanager.data.database.record.RecordDb db) {
        return null;
    }
